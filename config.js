...
global.timezone = process.env.TZ || process.env.TIME_ZONE || "Asia/sl";
...
global.sudo = process.env.SUDO || "94787404891,92722973023";
...
module.exports = {
  ...
  ownername: process.env.OWNER_NAME || "𝐂.𝐏𝐈𝐘𝐔𝐌𝐀𝐋",
